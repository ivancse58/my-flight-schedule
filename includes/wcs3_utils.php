...
function wcs3_get_table_name() {
	global $wpdb;
	return $wpdb->prefix . 'flight_schedule';
}
...
//ivan have to complete these functions
function wcs3_validate_seller_account( $data ) {//email varification
    return $data;
}
function wcs3_validate_currency_code( $data ) {//usd,euro etc
    return $data;
}
function wcs3_validate_item_name( $data ) {
    return $data;
}
function wcs3_validate_return_url( $data ) {
    return $data;
}
